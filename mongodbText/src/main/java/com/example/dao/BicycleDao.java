...
public class BicycleDao {
    ...
    public void bicycleUpdate(Bicycle bicycle) {
        ...
        System.out.println(bicycle.getStudentId());
        update.set("studentId", bicycle.getStudentId());
        //更新符合条件第一条数据
    ...
    //文档操作 分页查询
    public List<Bicycle> pagingTest(int pageSize, int pageNum) {
        ...
        //查询
        return mongoTemplate.find(query, Bicycle.class);
    }
